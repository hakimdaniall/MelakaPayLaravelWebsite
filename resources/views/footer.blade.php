  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 footer-contact">
            <h3>MelakaPay</h3>
            <p>
              Bahagian Teknologi Maklumat Dan Komunikasi Aras 1,<br>
              Blok Temenggong, Seri Negeri, Hang Tuah Jaya,<br>
              75450 Ayer Keroh, Melaka, Malaysia<br><br>
              <strong>Phone:</strong> +606-3333333 ext 7656/7749<br>
              <strong>Email:</strong> melakapay_admin@melaka.gov.my<br>
            </p>
          </div>
    ...
    <div class="container py-4">
      <div class="copyright">
        &copy; Copyright <strong><span>MelakaPay</span></strong>. All Rights Reserved
      </div>
    </div>
  </footer><!-- End Footer -->