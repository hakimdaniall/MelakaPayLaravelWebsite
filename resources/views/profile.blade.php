    ...
    <div class="container-fluid mt--7">
      <div class="row">
        <div class="col-xl-4 order-xl-2 mb-5 mb-xl-0">
          <div class="profilecard profilecard-profile shadow">
            <div class="row justify-content-center">
              <div class="col-lg-3 order-lg-2">
                
              </div>
            </div>
            <div class="profilecard-header text-center border-0 pt-8 pt-md-4 pb-0 pb-md-4">
            </div>
            <div class="profilecard-body pt-0 pt-md-4">
              <div class="row">
        ...
        <div class="col-xl-8 order-xl-1">
          <div class="profilecard bg-secondary shadow">
            <div class="profilecard-header bg-white border-0">
